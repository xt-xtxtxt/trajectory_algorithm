...
class Astar:
    ...
    def surrounding_point(self, parent):
        self.Process_point(parent.x + 1, parent.y, parent, 10)  # right
        self.Process_point(parent.x + 1, parent.y + 1, parent, 14.1)
        self.Process_point(parent.x, parent.y + 1, parent, 10)
        self.Process_point(parent.x - 1, parent.y + 1, parent, 14.1)
        self.Process_point(parent.x - 1, parent.y, parent, 10)  # left
        self.Process_point(parent.x - 1, parent.y - 1, parent, 141)
        self.Process_point(parent.x, parent.y - 1, parent, 10)
        self.Process_point(parent.x + 1, parent.y - 1, parent, 14.1)
    ...
    def G_x(self, point0):
        point0.H = abs(point0.x - self.begin.x)*10 + abs(point0.y - self.begin.y)*10
